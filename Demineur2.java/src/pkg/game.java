...
public class game extends JFrame {
    ...
    public game(int size, int toughness, int nb) {
...
//                            JOptionPane.ERROR_MESSAGE);
                    ...
                    Object[] options = {"Ré-essayer", "Quitter"};
                    int overGame = JOptionPane.showOptionDialog(null,
                            "Oh nooon! Vous avez perdu", "Démineur",
...
//                    
                    if(overGame == 0) {
//                    	this.game(size, toughness, nb);
//                        main(game, size);
                        Minesweeper m = new Minesweeper();
                        m.main(null);
                        
                    	System.out.println(size+","+toughness+","+nb);
                    } else {
